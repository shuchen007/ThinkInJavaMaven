...
//        params.put("${attach}", "无");
    ...
    public void testTemplateWrite() throws Exception {
        ...
        OutputStream os = new FileOutputStream("D:\\sta2.docx");
        doc.write(os);
        this.close(os);
        this.close(is);
    }
    ...
    public void myTest1() throws Exception {
        ...
        System.out.println(this.matcher("报告日期：${name}").find());
...
//                            break;
                    ...
                    for (String key : params.keySet()) {
                        if (str.equals(key)) {
                            para.insertNewRun(i).setText((String) params.get(key));
//                            para.createRun().setText((String) params.get(key),i);
                            break;
                        }
                    }
                    str="";
